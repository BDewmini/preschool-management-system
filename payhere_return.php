...
<title>Payment Successful – Little Stars Pre School</title>
...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  a { display:inline-block; background:#66BB6A; color:#fff; text-decoration:none; padding:12px 24px; border-radius:12px; font-weight:800; font-size:14px; }
</style>
...
<body>
  <div class="card">
    ...
    <p>Thank you! Your payment has been received. It may take a few seconds to reflect on your dashboard.</p>
